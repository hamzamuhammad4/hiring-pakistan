          ...
          <div className="p-6 md:p-8 space-y-8">
            ...
            <section id="contact">
              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                <p className="text-gray-700"><strong>Email:</strong> <a href="mailto:legal@hiringpakistan.com" className="text-cyan-600 hover:underline">legal@hiringpakistan.com</a></p>
                ...
                <p className="text-gray-700"><strong>Working Hours:</strong> Monday - Friday, 9:00 AM - 6:00 PM (PKT)</p>
              </div>
            </section>
